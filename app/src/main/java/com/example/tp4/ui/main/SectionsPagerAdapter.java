    ...
    public CharSequence getPageTitle(int position) {
        ...
        switch (position) {
            case 0:
                ...
                icone = mContext.getResources().getDrawable(R.drawable.ic_action_name);
                break;
            case 1:
                titre = mContext.getString(R.string.titre_section1).toUpperCase(l);
                icone = mContext.getResources().getDrawable(R.drawable.ic_action_nature);
                break;
            case 2:
                titre = mContext.getString(R.string.titre_section2).toUpperCase(l);
                icone = mContext.getResources().getDrawable(R.drawable.ic_action_pets);
                break;
            case 3:
